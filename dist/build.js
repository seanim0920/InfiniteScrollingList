...
/* harmony export */ });
/* harmony import */ var _objectWithoutPropertiesLoose_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(756);
...
var unsupportedIterableToArray = __webpack_require__(961);
...
var objectWithoutProperties = __webpack_require__(253);
// EXTERNAL MODULE: ./node_modules/@material-ui/utils/esm/deepmerge.js
var deepmerge = __webpack_require__(953);
...
var makeStyles = __webpack_require__(342);
...
var useTheme = __webpack_require__(959);
...
// EXTERNAL MODULE: ./node_modules/@material-ui/core/esm/styles/defaultTheme.js + 27 modules
...
var createSvgIcon = __webpack_require__(209);
...
var setRef = __webpack_require__(236);
...
var useEventCallback = __webpack_require__(192);
// EXTERNAL MODULE: ./node_modules/@material-ui/core/esm/utils/useForkRef.js
var useForkRef = __webpack_require__(834);
...
var useIsFocusVisible = __webpack_require__(896);
...
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(294);
/* harmony import */ var _setRef__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(236);
...
var React = _interopRequireWildcard(__webpack_require__(294));

var _createSvgIcon = _interopRequireDefault(__webpack_require__(108));
...
var inheritsLoose = __webpack_require__(552);
...
var toConsumableArray = __webpack_require__(329);
...
var _swipeJsIso = _interopRequireDefault(__webpack_require__(799));

var _lodash = _interopRequireDefault(__webpack_require__(307));
...
;// CONCATENATED MODULE: ./src/helperFunctions/ajaxCall.js
...
;// CONCATENATED MODULE: ./src/helperFunctions/getCurrentWindowSize.js
...
;// CONCATENATED MODULE: ./src/listComponents/ResponsiveListRow.js
function ResponsiveListRow_slicedToArray(arr, i) { return ResponsiveListRow_arrayWithHoles(arr) || ResponsiveListRow_iterableToArrayLimit(arr, i) || ResponsiveListRow_unsupportedIterableToArray(arr, i) || ResponsiveListRow_nonIterableRest(); }

function ResponsiveListRow_nonIterableRest() { throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }

function ResponsiveListRow_unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === "string") return ResponsiveListRow_arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return Array.from(o); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return ResponsiveListRow_arrayLikeToArray(o, minLen); }

function ResponsiveListRow_arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) { arr2[i] = arr[i]; } return arr2; }

function ResponsiveListRow_iterableToArrayLimit(arr, i) { var _i = arr == null ? null : typeof Symbol !== "undefined" && arr[Symbol.iterator] || arr["@@iterator"]; if (_i == null) return; var _arr = []; var _n = true; var _d = false; var _s, _e; try { for (_i = _i.call(arr); !(_n = (_s = _i.next()).done); _n = true) { _arr.push(_s.value); if (i && _arr.length === i) break; } } catch (err) { _d = true; _e = err; } finally { try { if (!_n && _i["return"] != null) _i["return"](); } finally { if (_d) throw _e; } } return _arr; }

function ResponsiveListRow_arrayWithHoles(arr) { if (Array.isArray(arr)) return arr; }
...
function ListRow(_ref) {
  var itemExists = _ref.itemExists,
      setRowSize = _ref.setRowSize,
      index = _ref.index,
      style = _ref.style,
      children = _ref.children;
  var cellContainer = (0,react.useRef)();

  var _useWindowSize = useWindowSize(),
      _useWindowSize2 = ResponsiveListRow_slicedToArray(_useWindowSize, 1),
  ...
  return (
    /*#__PURE__*/
    //the outer div applies a placeholder style, while the inner div measures the exact size of the cell
    react.createElement("div", {
      style: style,
      className: "Item"
    }, itemExists ? /*#__PURE__*/react.createElement("div", {
      ref: cellContainer
    }, //will we need item.id? probably as a key. take this part out and use it as an argument
    children) : /*#__PURE__*/react.createElement("h2", null, "Loading..."))
  );
}

;
ListRow.propTypes = {
  itemExists: (prop_types_default()).bool.isRequired,
  setRowSize: (prop_types_default()).func.isRequired,
...
var ResponsiveListRow = /*#__PURE__*/(0,react.memo)(ListRow, areEqual);
;// CONCATENATED MODULE: ./src/listComponents/ContainerHeightCalculator.js
function ContainerHeightCalculator_slicedToArray(arr, i) { return ContainerHeightCalculator_arrayWithHoles(arr) || ContainerHeightCalculator_iterableToArrayLimit(arr, i) || ContainerHeightCalculator_unsupportedIterableToArray(arr, i) || ContainerHeightCalculator_nonIterableRest(); }

function ContainerHeightCalculator_nonIterableRest() { throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }

function ContainerHeightCalculator_unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === "string") return ContainerHeightCalculator_arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return Array.from(o); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return ContainerHeightCalculator_arrayLikeToArray(o, minLen); }

function ContainerHeightCalculator_arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) { arr2[i] = arr[i]; } return arr2; }

function ContainerHeightCalculator_iterableToArrayLimit(arr, i) { var _i = arr == null ? null : typeof Symbol !== "undefined" && arr[Symbol.iterator] || arr["@@iterator"]; if (_i == null) return; var _arr = []; var _n = true; var _d = false; var _s, _e; try { for (_i = _i.call(arr); !(_n = (_s = _i.next()).done); _n = true) { _arr.push(_s.value); if (i && _arr.length === i) break; } } catch (err) { _d = true; _e = err; } finally { try { if (!_n && _i["return"] != null) _i["return"](); } finally { if (_d) throw _e; } } return _arr; }

function ContainerHeightCalculator_arrayWithHoles(arr) { if (Array.isArray(arr)) return arr; }



 //calculates the height of the containing element and passes it to the children

var ContainerHeightCalculator = function ContainerHeightCalculator(_ref) {
  var children = _ref.children;

  var _useWindowSize = useWindowSize(),
      _useWindowSize2 = ContainerHeightCalculator_slicedToArray(_useWindowSize, 2),
      windowWidth = _useWindowSize2[0],
      windowHeight = _useWindowSize2[1];

  var _useState = (0,react.useState)(0),
      _useState2 = ContainerHeightCalculator_slicedToArray(_useState, 2),
      containerHeight = _useState2[0],
      setContainerHeight = _useState2[1];

  var _useState3 = (0,react.useState)(null),
      _useState4 = ContainerHeightCalculator_slicedToArray(_useState3, 2),
  ...
  var getRootElement = (0,react.useCallback)(function (element) {
    if (element) setRootElement(element.parentNode);
  }, []);
...
;// CONCATENATED MODULE: ./src/helperFunctions/mergeRefs.js
function _createForOfIteratorHelper(o, allowArrayLike) { var it = typeof Symbol !== "undefined" && o[Symbol.iterator] || o["@@iterator"]; if (!it) { if (Array.isArray(o) || (it = mergeRefs_unsupportedIterableToArray(o)) || allowArrayLike && o && typeof o.length === "number") { if (it) o = it; var i = 0; var F = function F() {}; return { s: F, n: function n() { if (i >= o.length) return { done: true }; return { done: false, value: o[i++] }; }, e: function e(_e) { throw _e; }, f: F }; } throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); } var normalCompletion = true, didErr = false, err; return { s: function s() { it = it.call(o); }, n: function n() { var step = it.next(); normalCompletion = step.done; return step; }, e: function e(_e2) { didErr = true; err = _e2; }, f: function f() { try { if (!normalCompletion && it["return"] != null) it["return"](); } finally { if (didErr) throw err; } } }; }

function mergeRefs_unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === "string") return mergeRefs_arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return Array.from(o); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return mergeRefs_arrayLikeToArray(o, minLen); }

function mergeRefs_arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) { arr2[i] = arr[i]; } return arr2; }
...
;// CONCATENATED MODULE: ./src/listComponents/DynamicallySizedList.js
...
var DEFAULT_ROW_SIZE = 400;
var DynamicallySizedList = /*#__PURE__*/(0,react.forwardRef)(function (_ref, ref) {
  var items = _ref.items,
      changeList = _ref.changeList,
      onItemsRendered = _ref.onItemsRendered,
      children = _ref.children;
  var localListRef = (0,react.useRef)();
  var rowSizesMap = (0,react.useRef)({});
  var getRowSize = (0,react.useCallback)(function (index) {
    return rowSizesMap.current[index] || DEFAULT_ROW_SIZE;
  }, []);
  var setRowSize = (0,react.useCallback)(function (index, size) {
    if (rowSizesMap.current[index] !== size) {
      rowSizesMap.current[index] = size;
      localListRef.current.resetAfterIndex(index);
    }
  }, []);
  return /*#__PURE__*/react.createElement(ContainerHeightCalculator, null, function (height) {
    return /*#__PURE__*/react.createElement(VariableSizeList, {
      ...
      var index = _ref2.index,
          style = _ref2.style;
      return /*#__PURE__*/react.createElement(ResponsiveListRow, {
...
DynamicallySizedList.propTypes = {
  ...
  changeList: (prop_types_default()).func,
  onItemsRendered: (prop_types_default()).func
};
...
;// CONCATENATED MODULE: ./src/listComponents/InfinitelyLoadingList.js
function _toConsumableArray(arr) { return _arrayWithoutHoles(arr) || _iterableToArray(arr) || InfinitelyLoadingList_unsupportedIterableToArray(arr) || _nonIterableSpread(); }

function _nonIterableSpread() { throw new TypeError("Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }

function _iterableToArray(iter) { if (typeof Symbol !== "undefined" && iter[Symbol.iterator] != null || iter["@@iterator"] != null) return Array.from(iter); }

function _arrayWithoutHoles(arr) { if (Array.isArray(arr)) return InfinitelyLoadingList_arrayLikeToArray(arr); }

function InfinitelyLoadingList_slicedToArray(arr, i) { return InfinitelyLoadingList_arrayWithHoles(arr) || InfinitelyLoadingList_iterableToArrayLimit(arr, i) || InfinitelyLoadingList_unsupportedIterableToArray(arr, i) || InfinitelyLoadingList_nonIterableRest(); }

function InfinitelyLoadingList_nonIterableRest() { throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }

function InfinitelyLoadingList_unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === "string") return InfinitelyLoadingList_arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return Array.from(o); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return InfinitelyLoadingList_arrayLikeToArray(o, minLen); }

function InfinitelyLoadingList_arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) { arr2[i] = arr[i]; } return arr2; }

function InfinitelyLoadingList_iterableToArrayLimit(arr, i) { var _i = arr == null ? null : typeof Symbol !== "undefined" && arr[Symbol.iterator] || arr["@@iterator"]; if (_i == null) return; var _arr = []; var _n = true; var _d = false; var _s, _e; try { for (_i = _i.call(arr); !(_n = (_s = _i.next()).done); _n = true) { _arr.push(_s.value); if (i && _arr.length === i) break; } } catch (err) { _d = true; _e = err; } finally { try { if (!_n && _i["return"] != null) _i["return"](); } finally { if (_d) throw _e; } } return _arr; }

function InfinitelyLoadingList_arrayWithHoles(arr) { if (Array.isArray(arr)) return arr; }
...
var InfinitelyLoadingList = function InfinitelyLoadingList(_ref) {
  var children = _ref.children,
      loadMoreItemsAsync = _ref.loadMoreItemsAsync,
      _ref$loadingPoint = _ref.loadingPoint,
      loadingPoint = _ref$loadingPoint === void 0 ? 30 : _ref$loadingPoint;

  var _useState = (0,react.useState)(false),
      _useState2 = InfinitelyLoadingList_slicedToArray(_useState, 2),
      isNextPageLoading = _useState2[0],
      setIsNextPageLoading = _useState2[1];

  var _useState3 = (0,react.useState)(),
      _useState4 = InfinitelyLoadingList_slicedToArray(_useState3, 2),
      nextPageToken = _useState4[0],
      setNextPageToken = _useState4[1];

  var _useState5 = (0,react.useState)([null]),
      _useState6 = InfinitelyLoadingList_slicedToArray(_useState5, 2),
      data = _useState6[0],
      setData = _useState6[1];

  var isItemLoaded = function isItemLoaded(index) {
    return nextPageToken === null || index < data.length - loadingPoint;
  }; //condition to determine if we should load more items. why 0.3?


  var appendNewData = isNextPageLoading ? function () {} : function () {
    setIsNextPageLoading(true);
    loadMoreItemsAsync(nextPageToken).then(function (_ref2) {
      var _ref3 = InfinitelyLoadingList_slicedToArray(_ref2, 2),
          newItems = _ref3[0],
          nextPageToken = _ref3[1];

      var newData = _toConsumableArray(data);

      newData.pop();
      newData.push.apply(newData, _toConsumableArray(newItems));

      if (nextPageToken) {
        //what if it's the end of the list? make sure the list can end properly. test it
        newData.push(null);
      }
      ...
      return setIsNextPageLoading(false);
    });
  };

  var changeList = function changeList(changeDataFunction) {
    var newData = _toConsumableArray(data);

    var replaceData = changeDataFunction(newData);
    setData(replaceData);
  };
  ...
  return /*#__PURE__*/react.createElement(index_esm, {
    ...
    var onItemsRendered = _ref4.onItemsRendered,
        ref = _ref4.ref;
    return /*#__PURE__*/react.createElement(DynamicallySizedList, {
      items: data,
      changeList: changeList,
      onItemsRendered: onItemsRendered,
      ref: ref
...
InfinitelyLoadingList.propTypes = {
  loadMoreItemsAsync: (prop_types_default()).func.isRequired,
  children: (prop_types_default()).func.isRequired,
  loadingPoint: (prop_types_default()).number
};

;// CONCATENATED MODULE: ./src/helperFunctions/printTime.js
var printTime = function printTime(timestamp) {
  var dateInfo = new Date(timestamp);
...
// EXTERNAL MODULE: ./node_modules/@material-ui/icons/CloseRounded.js
var CloseRounded = __webpack_require__(138);
// EXTERNAL MODULE: ./node_modules/@material-ui/icons/CancelRounded.js
var CancelRounded = __webpack_require__(710);
// EXTERNAL MODULE: ./node_modules/clamp-js/clamp.js
var clamp = __webpack_require__(709);
var clamp_default = /*#__PURE__*/__webpack_require__.n(clamp);
// EXTERNAL MODULE: ./node_modules/react-swipe/lib/index.js
var lib = __webpack_require__(607);
var lib_default = /*#__PURE__*/__webpack_require__.n(lib);
;// CONCATENATED MODULE: ./src/messageComponents/Message.js
...
function Message(_ref) {
  var photoHost = _ref.photoHost,
      item = _ref.item,
      index = _ref.index,
      changeList = _ref.changeList;
  var indicatorRef = (0,react.useRef)();
  var swipeRef = (0,react.useRef)();
  var cardRef = (0,react.useRef)();

  var removeItem = function removeItem(array) {
  ...
  var swipeOptions = {
    continuous: false,
    startSlide: 1,
    swiping: function swiping(percentage) {
  ...
  var clampOverflow = (0,react.useCallback)(function (element) {
    if (element && element.clientHeight < element.scrollHeight) clamp_default()(element, {
      clamp: MAX_LINES,
  ...
  }, /*#__PURE__*/react.createElement(CardHeader_CardHeader, {
    avatar:
    /*#__PURE__*/
    //what units are proper??
    react.createElement(Avatar_Avatar, {
      className: classes.avatar,
      alt: item.author.name,
      src: photoHost + item.author.photoUrl,
      "aria-label": "recipe"
    }, item.author.name.charAt(0)),
    action: /*#__PURE__*/react.createElement(IconButton_IconButton, {
      "aria-label": "dismiss",
      onClick: function onClick() {
        if (swipeRef.current) swipeRef.current.prev();
      }
    }, /*#__PURE__*/react.createElement(CloseRounded/* default */.Z, null)),
    title: /*#__PURE__*/react.createElement("strong", null, index),
    subheader: /*#__PURE__*/react.createElement("small", null, printTime(item.updated))
  ...
  }, /*#__PURE__*/react.createElement(CancelRounded/* default */.Z, {
    style: {
      transform: 'scale(2)',
      "float": 'right',
      marginBottom: '1em',
...
Message.propTypes = {
  photoHost: (prop_types_default()).string.isRequired,
  item: (prop_types_default()).object,
  index: (prop_types_default()).number.isRequired,
  changeList: (prop_types_default()).func.isRequired
};
/* harmony default export */ const messageComponents_Message = (Message);
...
var loadMoreItemsAsync = function loadMoreItemsAsync(nextPageToken) {
  var url = 'http://message-list.appspot.com/messages?limit=' + batchSize;
  if (nextPageToken) url += '&pageToken=' + nextPageToken;
  return new Promise(function (resolve, reject) {
    ajaxCall(url).then(function (response) {
      return resolve([response.messages, response.pageToken]);
    }) //if this fails? //can't pass multiple values directly, as seen here https://stackoverflow.com/questions/28703625/how-do-you-properly-return-multiple-values-from-a-promise
    ["catch"](function (e) {
      return reject(e);
    });
  });
...
react_dom.render( /*#__PURE__*/react.createElement(InfinitelyLoadingList, {
  ...
  var item = _ref.item,
      ...
      changeList = _ref.changeList,
      setRowSize = _ref.setRowSize;
  return /*#__PURE__*/react.createElement(messageComponents_Message, {
